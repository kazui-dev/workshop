...
前方左右の HC-SR04 を片方ずつ確認する。それぞれの正面 7 cm 以内に障害物を置くとモーターが停止してブザーが鳴り、前進操作が抑止されることを確認する。この状態でも後退とその場旋回は可能である。

次に両方の正面へ障害物を置き、片方だけを 10 cm 以上に離しても前進抑止が続くことを確認する。両方を 10 cm 以上に離すと通常操作へ戻り、ブザーが停止することを確認する。
